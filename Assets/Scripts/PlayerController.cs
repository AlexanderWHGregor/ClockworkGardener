...
public class PlayerController : MonoBehaviour
{
    ...
    {
        // First enemy
        if (other.gameObject.name == "Hitbox1")
        {
            LoadPuzzle.setHealth(100);
            LoadPuzzle.setTimer(30);
        }
        // Second enemy
        if (other.gameObject.name == "Hitbox2")
        {
            LoadPuzzle.setHealth(400);
            LoadPuzzle.setTimer(40);
        }
        // Third enemy
        if (other.gameObject.name == "Hitbox3")
        {
            LoadPuzzle.setHealth(800);
            LoadPuzzle.setTimer(60);
        }
        // Final Boss
        if (other.gameObject.name == "HitboxBoss")
        {
            LoadPuzzle.setHealth(2000);
            LoadPuzzle.setTimer(90);
        }
    }
